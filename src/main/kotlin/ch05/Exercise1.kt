...
class FunctionsClassic {
    ...
    fun printNum(num: Int) = print(num)
    ...
    fun longestOf(str1: String, str2: String, str3: String): String {
        return maxOf(str1, str2, str3, compareBy { it.length })
    }
}
...
class AnonymousFunctionalTypeInferred {
    val add = fun(num1: Int, num2: Int): Int = num1 + num2

    val printNum = fun(num: Int): Unit = print(num)

    val triple = fun(num: Int): Int = num * 3

    val produceName = fun(name: String): Name = Name(name)

    val longestOf = fun(str1: String, str2: String, str3: String): String =
        maxOf(str1, str2, str3, compareBy { it.length })
}
